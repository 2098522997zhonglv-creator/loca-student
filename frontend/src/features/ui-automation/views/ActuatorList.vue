...
const pageText = computed(() => (
  isEnglish.value
    ? {
        ...
        startServiceHint: 'Start the actuator service first: cd loca_stude_Actuator && python main.py',
        status: 'Status',
        name: 'Name',
    ...
    : {
        ...
        refresh: '刷新',
        emptyTitle: '暂无在线执行器',
        startServiceHint: '请先启动执行器服务：cd loca_stude_Actuator && python main.py',
        status: '状态',
        name: '名称',
        ipAddress: 'IP地址',
        type: '类型',
